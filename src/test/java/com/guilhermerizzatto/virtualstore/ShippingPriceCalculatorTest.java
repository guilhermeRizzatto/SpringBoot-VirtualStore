...
class ShippingPriceCalculatorTest {
	...
	void checkTheShippingPriceWith2Products() throws ApiException, InterruptedException, IOException {
		...
		BigDecimal shippingPrice = ShippingPriceCalculator.calc(totalPriceOfProductItem, GoogleDirectionsAPI.getDistance(customerAddress), mousepad.getQuantity()+keyboard.getQuantity());
